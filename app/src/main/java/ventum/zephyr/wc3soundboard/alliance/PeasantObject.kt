...
object PeasantObject {
    ...
    fun createPeasants() = SoundItems().apply {
        ...
        add(SoundItem(drawables[i++ % drawables.size], R.raw.peasantyes2, R.string.peasantyes2))
        add(SoundItem(drawables[i++ % drawables.size], R.raw.peasantyes3, R.string.peasantyes3))
