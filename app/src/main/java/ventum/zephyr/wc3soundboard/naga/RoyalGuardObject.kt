...
object RoyalGuardObject {
    ...
    fun createRoyalGuard() = SoundItems().apply {
        ...
        add(SoundItem(drawables[i++ % drawables.size], R.raw.nagaroyalguardpissed4, R.string.nagaroyalguardpissed4, true))
        ...
        add(SoundItem(drawables[i++ % drawables.size], R.raw.nagaroyalguardpissed7, R.string.nagaroyalguardpissed7, true))
